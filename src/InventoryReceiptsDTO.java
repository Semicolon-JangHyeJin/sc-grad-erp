public class InventoryReceiptsDTO {
	...
	public InventoryReceiptsDTO(String d_DATE, int p_AMOUNT, int p_UNIT_PRICE, int p_PRICE, int s_AMOUNT,
			int s_UNIT_PRICE, int s_PRICE, String sALE_CODE, int sTOCK_AMOUNT, int sTOCK_UNIT_PRICE, int sTOCK_PRICE,
			String dESCRIPTION) {
		super();
		D_DATE = d_DATE;
		P_AMOUNT = p_AMOUNT;
	...
	public String toString() {
		return "InventoryReceiptsDTO [D_DATE=" + D_DATE + ", P_AMOUNT=" + P_AMOUNT + ", P_UNIT_PRICE=" + P_UNIT_PRICE
				...
				+ S_PRICE + ", SALE_CODE=" + SALE_CODE + ", STOCK_AMOUNT=" + STOCK_AMOUNT + ", STOCK_UNIT_PRICE="
				+ STOCK_UNIT_PRICE + ", STOCK_PRICE=" + STOCK_PRICE + ", DESCRIPTION=" + DESCRIPTION + "]";
	}
}
