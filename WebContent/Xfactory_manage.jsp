			...
			<br>
				...
				<hr>
			  	  <div class="form-row">
				    	...
				    	<label>공장코드</label>
				    	<input type="number" min="0" name="factoryId" class="form-control form-control-sm" id="factoryId" placeholder="공장코드">
				    </div>
				  ...
				  <div class="form-row">
				    <div class="form-group col-sm-6">
				    	<label>대표자</label>
				    	<input type="text" name="agentsearch" class="form-control form-control-sm" id="agent" placeholder="대표자 검색">
				    </div>
				    <div class="form-group col-sm-6">
				    	<label>　</label>
				    	<select name="personallist" class="form-control form-control-sm" id="personallist">
									<option value="문준식">문준식</option>
									<option value="장연수">장연수</option>
									<option value="장혜진">장혜진</option>
									<option value="배경율">배경율</option>
						</select>
				    </div>
				  </div>
				  ...
				  <div class="form-row">
				  	...
				  	<div class="form-group col-sm-3">
				  		<button type="submit" class="btn btn-primary btn-sm">공장정보 등록</button>
				  	</div>
				  </div>
			</form>
			<!-- 공장관리 폼 끝 -->
