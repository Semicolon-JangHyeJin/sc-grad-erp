...
<head>
	...
	var i =1;
 	function addItem()
  	{
		 var up_div  = document.getElementById("upload_div");
			...
			<br>
				...
				<hr>
			  	  <div class="form-row">
				    	...
				    	<label>생산코드</label>
				    	<input type="number" min="0" name="produceId" class="form-control form-control-sm" id="produceId" placeholder="생산ID">
				    </div>
				    <div class="form-group col-sm-4">
				    	<br>
					    <div class="checkbox">
				...
				<a href="javascript:addItem()">[+자재 추가+]</a>
