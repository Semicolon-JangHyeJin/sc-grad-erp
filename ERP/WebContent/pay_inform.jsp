			...
			<br>
				...
				<hr>
			  	...
			  	<div class="form-row">
			    	...
			    	<input type="text" name="paymentId" class="form-control form-control-sm" id="paymentId" placeholder="직급/호봉코드">
			   	</div><br>
				<div class="form-row">
			    	<label>호봉관리내역명</label>
				 ...
				 <div class="form-row">
				  ...
				  <div class="form-row">
				  	...
				  	<div class="form-group col-sm-3">
				  		<button type="submit" class="btn btn-primary btn-sm">호봉정보 등록</button>
				  	</div>
				  </div>
			</form>
			<!-- 호봉테이블등록 폼 끝 -->
