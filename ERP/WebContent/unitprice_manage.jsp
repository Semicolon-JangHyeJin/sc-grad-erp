				...
				<hr>
				 <div class="form-row">
				  ...
				  <div class="form-row">
					  <div class="form-group col-sm-6">
					    <label>품목 수량</label>
				    	<input type="text" name="count" class="form-control form-control-sm" id="count" placeholder="품목 수량">
					  </div>
					  <div class="form-group col-sm-6">
					    <label>품목 가격</label>
				    	<input type="text" name="price" class="form-control form-control-sm" id="price" placeholder="품목 가격">
				     </div>
				  </div><br>
				  <hr>
				  ...
				  <div class="form-row">
				  	...
				  	<div class="form-group col-sm-3">
				  		<button type="submit" class="btn btn-primary btn-sm">단가 등록</button>
				  	</div>
				  </div>
			</form>
			<!-- 거래처단가관리 폼 끝 -->
