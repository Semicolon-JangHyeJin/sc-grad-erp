			...
			<br>
				...
				<hr>
			  	  <div class="form-row">
				    	...
				    	<label>거래처코드</label>
				    	<input type="number" min="0" name="clientId" class="form-control form-control-sm" id="clientId" placeholder="거래처코드">
				    </div>
				  ...
				  <div class="form-row">
				  	<div class="form-group col-sm-8">
				    	<label>상호명</label>
				    	<input type="text" name="clientName" class="form-control form-control-sm" id="clientName" placeholder="상호명">
				  	</div>
				  	<div class="form-group col-sm-4">
				  	<br>
				  		<label class="radio-inline">
						  <input type="radio" name="saleORbuy" id="sale" value="sale">판매  
						</label>
						<label class="radio-inline">
						  <input type="radio" name="saleORbuy" id="buy" value="buy">구매
						</label>
					</div>
				  </div>
				  ...
				  <div class="form-row">
				  	<div class="form-group col-sm-6">
				    	<label>사업 종목</label>
				    	<input type="text" name="business" class="form-control form-control-sm" id="business" placeholder="사업 종목">
				    </div>
				    <div class="form-group col-sm-6">
				    	<label>대표자</label>
				    	<input type="text" name="agent" class="form-control form-control-sm" id="agent" placeholder="대표자">
				    </div>
				  </div>
				  ...
				  <div class="form-row">
				   	<label>팩스번호</label>
				    <input type="text" name="faxNum" class="form-control form-control-sm" id="faxNum" placeholder="팩스번호">
				  </div><br>
				  ...
				  <div class="form-row">
				  	...
				  	<div class="form-group col-sm-3">
				  		<button type="submit" class="btn btn-primary btn-sm">거래처코드 등록</button>
				  	</div>
				  </div>
			</form>
			<!-- 거래처코드관리 폼 끝 -->
